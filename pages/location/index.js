      ...
      <Layout>
        ...
        <Container style={{ background: "#eaeaea", paddingTop: "42px" }} fluid>
          ...
          <Container textAlign="left">
            <p style={{ textAlign: "justify" }}>
              Our venue can be found on the ground floor of the Saigon Pearl
              urban development area less than 10 min away from District 1
              featuring a corner location, outside seating and a great view of
              the never-ending flow of motorbikes and cars passing you by on
              Nguyen Huu Canh street. Saigon Pearl is nestled away from the
              hustle and bustle of the city while still offering the convenience
              of an urban lifestyle with great amenities all around including
              coffee shops, supermarkets, convenience stores and the like.{" "}
            </p>
            <p style={{ textAlign: "justify" }}>
              This new addition will bring you all El Gaucho has to offer, from
              our signature design elements, extensive menus, stellar service
              and of course Premium Steak cuts.{" "}
            </p>
          </Container>
        ...
        <Container style={{ paddingTop: "40px" }} fluid>
          <Header textAlign="center" as="h3" style={{ fontWeight: "400" }}>
            GF, SAIGON PEARL, 92A NGUYEN HUU CANH, WARD 22, BINH THANH DIST.,
            HCMC
          </Header>
          <Container textAlign="center">
            <p as="h5">Open Daily from 11AM to 10PM</p>
        ...
        >
          ...
          <Container>
            <p style={{ textAlign: "justify" }}>
              ...
              consulates, but also some of the most famous buildings, such as
              the Saigon Notre-Dame Basilica and the Opera House.{" "}
            </p>
            <p style={{ textAlign: "justify" }}>
              ...
              windows and partial balcony. The ground floor with its open
              kitchen and bar area, is not only the pulse of the restaurant, but
              also the welcome and lingering area.
            </p>
            <p style={{ textAlign: "justify" }}>
              With a rooftop having a stunning view of Saigon, this location is
              a preferred place for couples, families, business occasions and
              larger celebrating groups alike. In addition, the location offers
              private dining rooms as well as an exclusive event floor, for
              further details please visit our
              <strong>
                <Link href="/private-dining-events">
            ...
            <p style={{ textAlign: "justify" }}>
              ...
              floor, all other floors are non-smoking areas. Parking of
              motorbikes in front of the restaurant is allowed, car parking is
              available at Park Hyatt.
            </p>
          </Container>
          <Container textAlign="center" style={{ paddingBottom: "20px" }}>
            <ButtonCustomComponent
